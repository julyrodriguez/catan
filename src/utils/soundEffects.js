...
// Sintetizador procedural de efectos de sonido con Web Audio API (cero dependencias externas)
...
class SoundEffects {
  ...
  playDiceRoll() {
    ...
    // Simular el traqueteo de dados con múltiples impulsos
